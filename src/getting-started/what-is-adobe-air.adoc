...
For this reason, _Flash_ is not an option any longer if you plan on targeting the browser.
In such a case, there's no alternative to _HTML5/JavaSript_ -- be it directly or via a cross-compiling technology.
