...
Best of all, loading these animations in Starling is really easy if you add https://wiki.starling-framework.org/extensions/adobe-animate[this little extension] to your project.
...
.The _Adobe Animate_ extension comes with this cute sample animation by Chris Georgenes.
