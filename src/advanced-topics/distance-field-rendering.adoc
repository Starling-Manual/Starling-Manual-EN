...
Whatever tool or process you use, you will end up with a `.png` texture and a `.fnt` file, just like in this http://tinyurl.com/distance-field-font[sample].
...
var textField:TextField = new TextField(400, 100, "Make it so!");
